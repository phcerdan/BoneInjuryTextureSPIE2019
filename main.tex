...
\begin{frame}{Texture Analysis: Co-occurrence Matrix (GLCM)}
  \begin{columns}[onlytextwidth]
    ...
    \begin{itemize} \itemsep0.5em
      \item Energy
      \item \textbf{a}) Entropy
      \item \textbf{b}) Correlation
      \item \textbf{c}) Inverse Difference Moment (IDM)
      \item \textbf{d}) Inertia
      \item Cluster shade
      \item Cluster prominence
      \item \textbf{e}) Haralick’s correlation
    \end{itemize}
    \column{0.4\textwidth}
    \begin{columns}
      \centering
...
\begin{frame}{Bone Morphometry}
  ...
  \begin{columns}[onlytextwidth]
    ...
    \begin{itemize} \itemsep0.5em
      ...
      \item \textbf{e}) Trabecular number (Tb.N)
    \end{itemize}
    \column{0.4\textwidth}
    \begin{columns}
    \centering
